...
Yii::setAlias('@path-www-root', helpers_pl17_dir_get(__DIR__, 4,['www']));

Yii::setAlias('@link-web', '/');
Yii::setAlias('@link-api', '/api/');
Yii::setAlias('@path-web', Yii::getAlias('@path-www-root'));